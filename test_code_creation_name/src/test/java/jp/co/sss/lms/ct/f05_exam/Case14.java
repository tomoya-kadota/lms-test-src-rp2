...
public class Case14 {
	...
	void test06() {
		...
		answerList.add(webDriver.findElement(By.id("answer-0-0")));
		answerList.add(webDriver.findElement(By.id("answer-1-0")));
		answerList.add(webDriver.findElement(By.id("answer-2-1")));
		answerList.add(webDriver.findElement(By.id("answer-3-1")));
		answerList.add(webDriver.findElement(By.id("answer-4-0")));
		answerList.add(webDriver.findElement(By.id("answer-5-0")));
		answerList.add(webDriver.findElement(By.id("answer-6-3")));
		answerList.add(webDriver.findElement(By.id("answer-7-2")));
		answerList.add(webDriver.findElement(By.id("answer-8-1")));
		answerList.add(webDriver.findElement(By.id("answer-9-1")));
		answerList.add(webDriver.findElement(By.id("answer-10-1")));
		answerList.add(webDriver.findElement(By.id("answer-11-2")));
		...
		for (int i = 0; i < 12; i++) {
			...
			answerList.get(i).click();
			
			// 回答を１つずつ選択した後、エビデンス「suffix」（初期値：01、12まで取得）を取得
	...
	void test07() throws InterruptedException {
		...
		assertThat(webDriver.getTitle(), containsString("ITリテラシー①"));
		assertThat(scoreResult.getText(), containsString("あなたのスコア：50.0点"));
	}
	...
	void test08() {
		...
		assertThat(webDriver.getTitle(), containsString("試験【ITリテラシー①】"));
		assertThat(latestHistoryScore.getText(), containsString("50.0点"));
